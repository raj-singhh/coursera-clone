// src/main/java/com/example/coursera_clone/config/SecurityConfig.java
package com.example.coursera_clone.config;

import com.example.coursera_clone.security.jwt.AuthTokenFilter;
